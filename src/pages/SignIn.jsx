...
const SignIn = () => {
  ...
  return (
    <section>
      ...
      {/* Div for Both */}
      <div
        className="flex justify-around flex-wrap items-center px-6
      ...
      >
        ...
        <div className=" w-full md:w-[67%] lg:w-[40%]">
          <form onSubmit={onSubmit}>
            {/* Input Email */}
            <input
              className="w-full px-4 py-2 text-xl mb-2 text-gray-700
            ...
            <div className="relative ">
              {!show ? (
                ...
                <svg
                  className="w-6 h-6 absolute end-0 right-3 top-2
                ...
                >
                  <path
                    ...
                    d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226
                     16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228
            ...
            <div
              className="flex justify-between mt-5 whitespace-nowrap
             text-sm sm:text-lg"
            >
              <p className="flex">
            ...
            <button
              type="submit"
              className=" bg-blue-600 text-white w-full px-7 py-3
               rounded-md mt-3 text-sm font-medium uppercase shadow-md
            ...
            <div>
              <p
                className=" relative before:absolute before:bg-black
                  before:h-[0.5px] before:w-[45%] before:top-[50%] before:left-0
                   before:sm-w-[40%]
            after:absolute after:bg-black  after:h-[0.5px] after:w-[45%]
             after:top-[50%] after:right-0 after:sm-w-[40%]
